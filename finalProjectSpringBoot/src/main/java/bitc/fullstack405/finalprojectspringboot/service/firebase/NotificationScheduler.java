...
public class NotificationScheduler {
  ...
  public void sendNotification() {
    ...
    List<EventScheduleEntity> eventList = eventScheduleRepository.findUpcomingEventSchedules();
    ...
    for(EventScheduleEntity event : eventList) {
      ...
      data.put("body", event.getEvent().getEventTitle() + " 행사가 1주일 후에 진행됩니다. 자세한 사항은 신청 내역을 참고해주세요!");

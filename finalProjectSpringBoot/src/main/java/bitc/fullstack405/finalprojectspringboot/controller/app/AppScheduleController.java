...
//
//        // 올바른 QR 코드인지 확인(db랑 데이터 매칭이 되는지(날짜, 행사 등), 이미 사용한 qr 코드인지)
//
//        // 행사 제목, 회원 이름, 회원 전화번호 반환
//        AppQRScanResponse checkInfo = eventScheduleService.qrScan(eventId, scheduleId, userId);
